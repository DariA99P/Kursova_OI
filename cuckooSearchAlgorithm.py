...
class cso(pointsFunction.sw):
    ...
    def __init__(self, n, function, lb, ub, dimension, iteration, pa=0.25,
        ...
        """
         ...
         pa: вероятность обнаружения яйца кукушки (значение по умолчанию 0,25)
         nest: количество гнезд (значение по умолчанию 100)
        """
    ...
    """Функция для реализации полетов Леви"""
    ...
    """Функция, которая возвращает историю гнезд кукушек"""
    def get_nests(self):
        return self.__Nests
